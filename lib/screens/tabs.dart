...
import "package:drfungus_prod/screens/search.dart";
import "package:flutter/material.dart";
import "package:drfungus_prod/screens/datalist.dart";
import "package:drfungus_prod/screens/home_page.dart";
...
class _TabsScreenState extends State<TabsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_selectedPageIndex == 1) {
      ...
      activePage = const DataListScreen(title: "Fungi");
      ...
      activePage = const DataListScreen(title: "Medications");
    } else if (_selectedPageIndex == 4) {
      setState(() {
        activePageTitle = "Mycoses";
      });
      activePage = const DataListScreen(title: "Mycoses");
    }
